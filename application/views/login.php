...
<!-- Mirrored from codervent.com/bulona/demo/authentication-signin.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Sep 2019 17:27:11 GMT -->
<head>
  <meta charset="utf-8"/>
		...
		<div class="card-body">
		 <div class="card-content p-2">
          ...
          <?php echo '<label style="color:red">'.$this->session->flashdata("error").'</label>'; ?>
		    <?php echo form_open_multipart('path-process'); ?> 
